...
import com.chess.engine.board.variants.SpartanChess.SpartanKing;

public class SpartanPlayer extends BlackPlayer {
	Piece otherKing;
	boolean otherKingInCheck;
	
	public SpartanPlayer(final Board board, final Collection<Move> whiteStandardLegalMoves,
	...
	protected Piece establishKing() {
		...
		return new SpartanKing(Alliance.BLACK, -1, false);
	}
